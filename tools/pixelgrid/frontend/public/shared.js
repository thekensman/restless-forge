...
(function () {
  ...
  window.pgHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">🧩 PixelGrid</a>' +
  ...
  window.pgFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; PixelGrid.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('pg-header');
    if (h) h.outerHTML = window.pgHeader();
    var f = document.getElementById('pg-footer');
    if (f) f.outerHTML = window.pgFooter();
  });
})();
