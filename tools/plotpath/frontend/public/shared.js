...
(function () {
  ...
  window.ppHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">🖊️ PlotPath</a>' +
  ...
  window.ppFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; PlotPath.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('pp-header');
    if (h) h.outerHTML = window.ppHeader();
    var f = document.getElementById('pp-footer');
    if (f) f.outerHTML = window.ppFooter();
  });
})();
