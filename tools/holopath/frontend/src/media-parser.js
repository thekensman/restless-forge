...
function imageToImageData(img, maxWidth = 800) {
...
// ─── Static image parser ────────────────────────────
async function parseStaticImage(file, maxWidth) {
...
// ─── Animated GIF parser ────────────────────────────
async function parseAnimatedGif(file, maxWidth) {
...
function seekAndCapture(video, time, maxWidth) {
    return new Promise((resolve, reject) => {
...
async function parseVideo(file, maxWidth, onProgress) {
 ...
 */
export async function parseMedia(file, maxWidth = 512, onProgress) {
