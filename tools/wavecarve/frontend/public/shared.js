...
(function () {
  ...
  window.wcHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">🎵 WaveCarve</a>' +
  ...
  window.wcFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; WaveCarve.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('wc-header');
    if (h) h.outerHTML = window.wcHeader();
    var f = document.getElementById('wc-footer');
    if (f) f.outerHTML = window.wcFooter();
  });
})();
