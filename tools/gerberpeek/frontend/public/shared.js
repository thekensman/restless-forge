...
(function () {
  ...
  window.gpHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">📐 GerberPeek</a>' +
  ...
  window.gpFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; GerberPeek.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('gp-header');
    if (h) h.outerHTML = window.gpHeader();
    var f = document.getElementById('gp-footer');
    if (f) f.outerHTML = window.gpFooter();
  });
})();
