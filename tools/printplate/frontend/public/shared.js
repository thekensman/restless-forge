...
(function () {
  ...
  var navLinks = [
    [base + '/', 'Troubleshooter'], [base + '/faq/', 'FAQ'],
  ...
  window.pplHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">🖨️ PrintPlate</a>' +
  ...
  window.pplFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; PrintPlate.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('ppl-header');
    if (h) h.outerHTML = window.pplHeader();
    var f = document.getElementById('ppl-footer');
    if (f) f.outerHTML = window.pplFooter();
  });
})();
