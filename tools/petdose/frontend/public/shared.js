...
(function () {
  ...
  window.pdHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">🐾 PetDose</a>' +
  ...
  window.pdFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; PetDose.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('pd-header');
    if (h) h.outerHTML = window.pdHeader();
    var f = document.getElementById('pd-footer');
    if (f) f.outerHTML = window.pdFooter();
  });
})();
