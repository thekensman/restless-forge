...
(function () {
  ...
  window.cfHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">⚙️ CNCFeed</a>' +
  ...
  window.cfFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; CNCFeed.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('cf-header');
    if (h) h.outerHTML = window.cfHeader();
    var f = document.getElementById('cf-footer');
    if (f) f.outerHTML = window.cfFooter();
  });
})();
