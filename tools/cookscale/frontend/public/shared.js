...
(function () {
  ...
  window.csHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">🍳 CookScale</a>' +
  ...
  window.csFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; CookScale.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('cs-header');
    if (h) h.outerHTML = window.csHeader();
    var f = document.getElementById('cs-footer');
    if (f) f.outerHTML = window.csFooter();
  });
})();
