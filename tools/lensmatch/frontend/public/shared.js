...
(function () {
  ...
  window.lmHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">📷 LensMatch</a>' +
  ...
  window.lmFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; LensMatch.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('lm-header');
    if (h) h.outerHTML = window.lmHeader();
    var f = document.getElementById('lm-footer');
    if (f) f.outerHTML = window.lmFooter();
  });
})();
