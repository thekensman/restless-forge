...
(function () {
  ...
  window.kgHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">🪢 KnotGuide</a>' +
  ...
  window.kgFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; KnotGuide.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('kg-header');
    if (h) h.outerHTML = window.kgHeader();
    var f = document.getElementById('kg-footer');
    if (f) f.outerHTML = window.kgFooter();
  });
})();
