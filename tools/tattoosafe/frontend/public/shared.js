...
(function () {
  ...
  window.tsHeader = function () {
    ...
    return '<header class="site-header"><div class="site-header__inner"><div class="site-header__top">' +
      '<a class="site-header__brand" href="' + base + '/">&#x1F58B; TattooSafe</a>' +
  ...
  window.tsFooter = function () {
    ...
    return '<footer class="footer">' + donateHtml +
      ...
      '<p class="footer__copy">&copy; 2026 <a href="/" style="color:inherit;text-decoration:none;">Restless Forge</a> &mdash; TattooSafe. Your design, your body, your browser.</p></footer>';
  };
  document.addEventListener('DOMContentLoaded', function () {
    var h = document.getElementById('ts-header');
    if (h) h.outerHTML = window.tsHeader();
    var f = document.getElementById('ts-footer');
    if (f) f.outerHTML = window.tsFooter();
  });
})();
